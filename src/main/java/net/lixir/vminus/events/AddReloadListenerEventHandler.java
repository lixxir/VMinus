...
import net.lixir.vminus.visions.resources.managers.*;
...
public class AddReloadListenerEventHandler {
    ...
    public static void AddReloadListenerEvent(AddReloadListenerEvent event) {
        ...
        event.addListener(new CreativeTabVisionManager(context));
        event.addListener(new EffectVisionManager(context));
    }
