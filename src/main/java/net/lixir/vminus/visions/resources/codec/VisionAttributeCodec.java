...
public class VisionAttributeCodec extends AbstractVisionCodec<VisionAttribute> {
    @Override
    public @Nullable List<VisionValue<VisionAttribute>> decode(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
        List<VisionValue<VisionAttribute>> visionValues = new ArrayList<>();
        ...
        for (JsonElement jsonArrayElement : jsonArray) {
            ...
            visionValues.add(VisionValue.create(visionAttribute, arrayObject, jsonObject, key));
        }
        return visionValues;
    }
}
