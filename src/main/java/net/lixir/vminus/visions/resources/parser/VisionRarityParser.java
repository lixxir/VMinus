...
public class VisionRarityParser extends VisionEnumParser<Rarity> {
    public VisionRarityParser() {
        super(Rarity.class);
    }

    @Override
    public @Nullable List<VisionValue<Rarity>> parse(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
