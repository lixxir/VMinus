...
public class VisionAttributeParser extends AbstractVisionParser<VisionAttribute> {
    @Override
    public @Nullable List<VisionValue<VisionAttribute>> parse(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
