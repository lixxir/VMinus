...
public class VisionItemDecoratorParser extends AbstractVisionParser<VisionItemDecorator> {
    @Override
    public @Nullable List<VisionValue<VisionItemDecorator>> parse(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
