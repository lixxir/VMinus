...
public class VisionFoodPropertiesParser extends AbstractVisionParser<VisionFoodProperties> {
    @Override
    public @Nullable List<VisionValue<VisionFoodProperties>> parse(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
