...
public class VisionFoodPropertiesCodec extends AbstractVisionCodec<VisionFoodProperties> {
    @Override
    public @Nullable List<VisionValue<VisionFoodProperties>> decode(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
        List<VisionValue<VisionFoodProperties>> visionValues = new ArrayList<>();
        ...
        for (JsonElement jsonArrayElement : jsonArray) {
            ...
            visionValues.add(VisionValue.create(visionFoodProperties, arrayObject, jsonObject, key));
        }
        return visionValues;
    }
