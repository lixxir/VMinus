...
public class VisionDoubleParser extends AbstractVisionParser<Double> {
    @Override
    public @Nullable List<VisionValue<Double>> parse(JsonObject jsonObject, String key, ICondition.IContext context) throws JsonParseException {
