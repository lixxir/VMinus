...
// Handler for allowing multiple names for vision properties for intuitiveness
public class VisionPropertyNameHandler {

    // All property names of one specific property
    private static final HashMap<String, List<String>> PROPERTY_NAME_KEY = new HashMap<>() {{
