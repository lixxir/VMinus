...
public abstract class VItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        for (Pair<Item, ItemEntry> entryPair : VRegistry.fromId(modId).getItemEntryPairs()) {
            Item item = entryPair.getFirst();
            ItemEntry itemEntry = entryPair.getSecond();
