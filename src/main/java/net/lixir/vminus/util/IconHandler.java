...
public class IconHandler {
    ...
    static {
        ...
        icons.put("sprint_momentum", icons.get("reset") + "\uEF02");
        icons.put("translucence", icons.get("reset") + "\uEF03");
        // Colors
        ...
        attributeIcons.put("vminus:translucence", "translucence");
        attributeIcons.put("vminus:health_lost_stat_boost", "health_lost_stat_boost");
        attributeIcons.put("vminus:sprint_momentum", "sprint_momentum");
